        ...
        <div className="grid grid-cols-12 px-52  h-full  gap-4">
          ...
          <div className="col-span-8 p-4  flex flex-col bg-amarelo rounded-lg">
            ...
            <div className="flex flex-col justify-between h-full">
              ...
              <div className="flex  gap-1">
                <p>Jogando:</p> <span>10</span>
              </div>
              <div className="flex  gap-1">
                <p>Completos:</p> <span>30</span>
              </div>
              <div className="flex  gap-1">
                <p>Quero jogar:</p> <span>5</span>
              </div>
              <div className="flex  gap-1">
                <p>Não aguento mais:</p> <span>15</span>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-8 p-4  bg-amarelo rounded-lg">
            ...
            <div className="overflow-auto max-h-48">
              <span>
                ...
                Similique molestiae dolore cupiditate, minima eveniet,
                aspernatur earum ad aliquid, necessitatibus asperiores
                dignissimos maiores voluptatibus reprehenderit dicta quis
                tempore facere dolores repellendus? Lorem ipsum dolor sit amet
                consectetur adipisicing elit. Quisquam odit, reiciendis non ex
                minima labore, optio temporibus, numquam eaque officia nihil
                corrupti distinctio quibusdam! Itaque quas quam doloremque
                tempore perferendis! Lorem, ipsum dolor sit amet consectetur
                adipisicing elit. Veniam esse inventore praesentium odit
                nesciunt nihil rerum quaerat, maxime officiis numquam totam,
                optio est mollitia laboriosam. Nisi perspiciatis tenetur velit
                labore. Lorem ipsum dolor sit amet, consectetur adipisicing
                elit. Animi eos, corporis ad nulla totam magni repellendus
                temporibus aliquam deserunt voluptatem. Dolorum rerum
                repudiandae reprehenderit nihil non deserunt doloremque harum
                illum!
              </span>
            </div>
          </div>
