                    ...
                    <div className="col-span-4 row-span-2 bg-amarelo rounded-lg p-4">
                        ...
                        <div className="mt-12 mb-6 w-full flex flex-col items-center justify-center gap-6">
                            <img
                                ...
                                alt=""
                            />
                            <span className="text-2xl  uppercase">akumak</span>
                        </div>
                    ...
                    <div className="col-span-8 p-4  bg-amarelo rounded-lg">
                        ...
                        <div className="overflow-auto max-h-48">
                            <span>
                                ...
                                adipisicing elit. Similique molestiae dolore
                                cupiditate, minima eveniet, aspernatur earum ad
                                aliquid, necessitatibus asperiores dignissimos
                                maiores voluptatibus reprehenderit dicta quis
                                tempore facere dolores repellendus? Lorem ipsum
                                dolor sit amet consectetur adipisicing elit.
                                Quisquam odit, reiciendis non ex minima labore,
                                optio temporibus, numquam eaque officia nihil
                                corrupti distinctio quibusdam! Itaque quas quam
                                doloremque tempore perferendis! Lorem, ipsum
                                dolor sit amet consectetur adipisicing elit.
                                Veniam esse inventore praesentium odit nesciunt
                                nihil rerum quaerat, maxime officiis numquam
                                totam, optio est mollitia laboriosam. Nisi
                                perspiciatis tenetur velit labore. Lorem ipsum
                                dolor sit amet, consectetur adipisicing elit.
                                Animi eos, corporis ad nulla totam magni
                                repellendus temporibus aliquam deserunt
                                voluptatem. Dolorum rerum repudiandae
                                reprehenderit nihil non deserunt doloremque
                                harum illum!
                            </span>
                        </div>
                    </div>
